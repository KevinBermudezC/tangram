...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-[var(--radius)] text-sm font-medium transition-[color,background-color,border-color,box-shadow,transform] duration-150 ease-out active:scale-[0.97] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-tint disabled:pointer-events-none disabled:opacity-60 disabled:active:scale-100",
  {
    variants: {
      variant: {
        primary:
          "bg-accent text-ink-on-accent hover:bg-accent-strong shadow-[0_1px_0_rgba(26,26,26,0.04),0_1px_3px_rgba(197,40,61,0.32)]",
        secondary:
